...
def createTable():
	con=mysql.connector.connect(host="localhost",user="root",passwd="shiv",database="t1_27_57")
	a=con.cursor()
...
label1=Label(w, text="College Name")
label1.grid(row=7, column=0)

e2=Entry(w, width=50)
e2.grid(row=7, column=1, padx=30)

label2=Label(w, text="Roll No")
...
w.mainloop()
#mydb = mysql.connector.connect(host="localhost",user="root",passwd="shiv",database="t1_27_57")
